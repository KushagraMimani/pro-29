...
function setup() {
  ...
  //level 1
  block17 = new Block(690,400,30,40);
  block18 = new Block(720,400,30,40);
  block19 = new Block(750,400,30,40);
  block20 = new Block(780,400,30,40);
  block21 = new Block(810,400,30,40);
  block22 = new Block(840,400,30,40);
  block23 = new Block(870,400,30,40);

  //level 2
  block24 = new Block(720,440,30,40);
  block25 = new Block(750,440,30,40);
  block26 = new Block(780,440,30,40);
  block27 = new Block(810,440,30,40);
  block28 = new Block(840,440,30,40);

  //level 3
  block29 = new Block(750,480,30,40);
  block30 = new Block(780,480,30,40);
  block31 = new Block(810,480,30,40);

  //level 4 (last)
  block32 = new Block(780,520,30,40);
